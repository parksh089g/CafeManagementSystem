...
$sql = "INSERT INTO working (id, date, time) VALUES (" . $_GET['id'] . ",\"". $_GET['date']."\",".$_GET['time'].")";


if (mysqli_query($conn, $sql)) {
    echo "<script>alert(\"갱신이 완료되었습니다.\");</script>";
    echo "<script>location.href='http://localhost/databasePROJECT/update_working.php'</script>";
} else {
